# WPIP-07: Embedded STUN/TURN Service
...
A `wpdaemon` node implementing WPIP-07 MUST provide a UDP STUN responder service:
...
Implementations adopting WPIP-07 SHOULD allow enabling/disabling the STUN/TURN service via configuration (`turn_enabled = true / false`).
